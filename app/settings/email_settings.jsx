...
export function EmailSettings() {
        ...
        const fetchEmailSettings = async () => {
            ...
            try {
                const response = await fetch(
                    `http://localhost:3001/api/email-settings/${storeName}`,
                    {
                        method: "GET",
                        headers: {
                ...
                setAutomaticallySendInvoicesWhenTheOrdersAreCreatedSelectedOption(data.automaticallySendInvoicesWhenTheOrdersAreCreatedSelectedOption);
                setIsOn(data.automaticEmailNotificationsForCustomers);
    ...
    const handleSubmit = async (event) => {
        ...
        const requestBody = {
            automaticallySendInvoicesWhenTheOrdersAreCreatedSelectedOption: automaticallySendInvoicesWhenTheOrdersAreCreatedSelectedOption,
            automaticEmailNotificationsForCustomers: isOn,
