...
export const OfflineEmail = () => {
    ...
    const fetchLogoUrl = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setFormValues(
            {
              subject: data.emailFormate.offline_order_email.subject
            }
          );
          setBody(data.emailFormate.offline_order_email.body);
  ...
  const handleSave = () => {
    ...
    fetch('http://localhost:3001/api/email-formate', {
      ...
      body: JSON.stringify({
        online_order_email: emailFormate.emailFormate.online_order_email,
        offline_order_email: {
