      ...
      >
        ...
        >
          <div>
            ...
            >
              Offline Order Notification Email Content
            </h1>
          </div>
          <button
            onClick={handleSave}
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <RichTextEditor text="<p>Hi <strong>Customer_Name,</strong></p><p><br></p><h2><strong>Thank you for your purchase!</strong></h2><p>we're getting your order ready to be shipped.We will notify you when it has been sent.</p><p><br></p><p><br></p><p>Kindly Download your invoice of your invoice<strong> Invoice_Number.</strong></p>"/>
          </div>
