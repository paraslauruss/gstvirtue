...
export default function Dashboard() {
    ...
    const ProgressBar = ({ progress }) => {
        return (
            <div style={{ width: "100%", backgroundColor: "#E2EBD6", borderRadius: "20px", margin: "20px 0" }}>
                <div
                    style={{
                        width: `${progress}%`,
                        height: "20px",
    ...
    const steps = ["Setup Product GST/HSN", "Customize Invoice Template", "Fill up Company Details and Legal Informantion "];
                            ...
                            >
                                ...
                                <div
                                    style={{
                                        ...
                                        height: "15px",
                                        borderRadius: "50%",
                                        backgroundColor: index <= activeStep ? "#74A535" : "#9B9B9B",
                                        color: "#fff",
                                        display: "flex",
                                        justifyContent: "top",
                                        alignItems: "top",
        ...
        <div>
            <Page>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <div style={{ color: 'white', backgroundColor: '#74A535', alignContent: 'center', padding: '10px 20px', borderRadius: '5px' }}>
                ...
                <div style={{ display: 'flex', marginTop: '20px', gap: '20px' }}>
                    <div style={{ width: '100%' }}>
                        <Card>
                            ...
                            <div style={{ color: '#919090' }}>
                                <Text variant="headingMd">5 Orders</Text>
                            </div>
                    ...
                    <div style={{ width: '100%' }}>
                        <Card>
                            ...
                            <div style={{ color: '#919090' }}>
                                <Text variant="headingMd">8 Products</Text>
                            </div>
                            <div style={{ color: '#74A535', marginTop: '10px' }}>
                                <Text variant="heading2xl">8</Text>
                            </div>
                        </Card>
                    </div>
                    ...
                    <div style={{ width: '100%' }}>
                        <Card>
                            ...
                            <div style={{ color: '#919090' }}>
                                <Text variant="headingMd">10 Customers</Text>
                            </div>
                            <div style={{ color: '#74A535', marginTop: '10px' }}>
                                <Text variant="heading2xl">10</Text>
                            </div>
                        </Card>
                    </div>
                    ...
                    <div style={{ width: '100%' }}>
                        <Card>
                            ...
                            <div style={{ color: '#919090' }}>
                                <Text variant="headingMd">2 Orders</Text>
                            </div>
                            <div style={{ color: '#74A535', marginTop: '10px' }}>
                                <Text variant="heading2xl">2</Text>
                            </div>
                        </Card>
                    </div>
                </div>
                ...
                <div style={{ marginTop: '20px' }}>
                    <Card>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                            ...
                            <Text variant="headingMd" fontWeight="bold">Do you have a question?  Visit our help center to learn  more.</Text>
                            <Text variant="headingMd" fontWeight="regular">With our help center, you can learn everything you need to know about our app.</Text>
                        </div>
                    </Card>
                </div>
            </Page>
