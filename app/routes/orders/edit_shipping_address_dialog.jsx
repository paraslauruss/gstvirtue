...
export function EditShippingAddressDialog({ active, toggleModal, customerDetails, apiCallbackEdit }) {
    ...
    useEffect(() => {
        if (customerDetails && customerDetails.shipping_address) {
          setFormValues({
            billingName: customerDetails.shipping_address.name || "",
            companyName: customerDetails.company_name || "",
            address: customerDetails.shipping_address.address1 || "",
            apartment: customerDetails.shipping_address.address2 || "",
            billingCity: customerDetails.shipping_address.city || "",
            billingState: customerDetails.shipping_address.province || "",
            billingPincode: customerDetails.shipping_address.zip || "",
            billingPhone: customerDetails.shipping_address.phone || "",
          });
        }
      }, [customerDetails]);
    ...
    const handleSubmit = async (e) => {
        ...
        const requestData = {
            customer_id: customerDetails.shopifyId,
            shipping_address: {
          ...
          try {
            ...
            const response = await fetch(`http://localhost:3001/api/customers/update-shipping-address`, {
              method: "PUT",
              headers: {
            ...
            toggleModal();
            apiCallbackEdit(responseData.updatedCustomer);
          } catch (error) {
        ...
        <div>
            ...
            {active && (
                ...
                >
                    ...
                    >
                        <div style={{ color: 'white', fontSize: '20px' }}>Change Shipping Address</div>
